...
export const post: NewsPost = {
  ...
  content: [
    ...
    {
      type: "paragraph",
      text: "Remote Therapeutic Monitoring (RTM) is expanded to include services for medication adherence and behavioral health. Additionally, the rule makes virtual supervision permanent. For “incident-to” billing, the physician now only needs to provide general supervision and does not need to be physically in the office.",
    },
    {
      type: "heading",
      level: 2,
    ...
    {
      type: "paragraph",
      text: "By layering these programs, practices can capture revenue for shorter monitoring periods and brief check-ins that were previously uncompensated. This increases recurring revenue per patient and provides a clearer path to financial sustainability.",
    },
    {
      type: "heading",
      level: 2,
    ...
    },
    {
      type: "list",
      items: [
        "Documentation: Include time spent, device data, and proof of patient engagement.",
        "Patient Consent: Must be obtained and properly recorded before initiating services.",
        "Workflows: Clear workflows are essential to delegate monitoring and engagement to trained staff.",
      ],
    },
    {
      type: "paragraph",
      text: "Early implementation of these updated rules not only builds recurring revenue but also fosters stronger patient relationships. ProactiveWellness offers options from Turnkey Enrollment Campaigns to Physician Partnership Models.",
    },
  ],
};
