...
export const post: NewsPost = {
  ...
  content: [
    {
      type: "paragraph",
      text: "Remote patient monitoring (RPM) is a way of using technology to track your health and medical data and share it with your healthcare provider. RPM can help you manage your condition, improve your outcomes, and reduce your costs. This blog explains what RPM is and provides a step by step guide to get started.",
    },
    {
      type: "heading",
      level: 2,
    ...
    },
    {
      type: "heading",
      level: 2,
      text: "How does remote patient monitoring work?",
    },
    {
      type: "paragraph",
      text: "RPM works by following these steps:",
    },
    {
      type: "list",
      ordered: true,
    ...
    },
    {
      type: "heading",
      level: 2,
      text: "How can you get started with remote patient monitoring?",
    },
    {
      type: "paragraph",
      text: "If you are interested in RPM, you can talk to your provider about it and see if they offer it or can refer you to someone who does. You can also do some research online to find out more about RPM devices and platforms that are available for different conditions.",
    },
    {
      type: "paragraph",
      text: "Some questions you may want to ask before starting RPM are:",
    },
    {
      type: "list",
      ordered: false,
    ...
    },
    {
      type: "heading",
      level: 2,
      text: "What are some examples of remote patient monitoring?",
    },
    {
      type: "paragraph",
      text: "RPM can be used for a variety of conditions and symptoms, depending on your needs and goals. Here are some examples of RPM for specialties:",
    },
    {
      type: "heading",
      level: 2,
    ...
    {
      type: "paragraph",
      text: "RPM can help manage heart conditions like hypertension and heart failure by monitoring indicators like blood pressure and heart rate. RPM can also help your provider adjust your medication dosage, order tests, or schedule appointments based on your data.",
    },
    {
      type: "heading",
      level: 2,
    ...
    {
      type: "paragraph",
      text: "RPM can help manage respiratory conditions like COPD and asthma by monitoring indicators like oxygen saturation and lung function. RPM can also help your provider prescribe inhalers, oxygen therapy, or other treatments based on your data.",
    },
    {
      type: "heading",
      level: 2,
    ...
    {
      type: "paragraph",
      text: "RPM can help manage endocrine conditions by monitoring indicators like blood glucose and thyroid hormones. It can help providers adjust insulin dosage, recommend dietary changes or refer to a nutritionist.",
    },
    {
      type: "paragraph",
